...
// seleccionar una tarea al hacer clic en su texto
...
// editar las tareas al hacer clic en "Editar"
document.getElementById('editTask').addEventListener('click', function () {
    habilitarEdicion();
});
//-----------------------

// ordenar alfabéticamente las tareas al hacer clic en "Ordenar"
...
// reordenar las tareas al hacer clic en "Reordenar"
